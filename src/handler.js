...
const addBookHandler = (request, h) => {
  ...
  const newBook = { id, name, year, author, summary, publisher, pageCount, readPage, finished: readPage == pageCount, reading, insertedAt, updatedAt };
...
//module.exports = { addBookHandler, getAllBookHandler, getBookByIdHandler, updateBookHandler, deleteBookByIdHandler };